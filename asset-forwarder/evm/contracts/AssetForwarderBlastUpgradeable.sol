...
contract AssetForwarderBlastUpgradeable is
    Initializable,
    PausableUpgradeable,
    ...
    IAssetForwarder
{
    ...
    address constant BlastPointsAddress = 0x2536FE9ab3F511540F2f9e2eC2A805005C3Dd800;
    ...
    function update(
        ...
        if (index == 1) {
            ...
            IBlastPoints(BlastPointsAddress).configurePointsOperator(_address);
        }
    }
